...
<section className="grid grid-cols-4 gap-5">
 ...
 <Breadcrumb currentPage={`Nonton ${episode?.epsTitle}`} />
  ...
  <HeaderEpisodeList episode={episode?.episodeList} query={query.id} type="download" />

  <SinglePageTabs currentTabs={currentTabs} openTabs={openTabs}   />
